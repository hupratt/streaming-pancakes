              ...
              <div style={{ display: "flex" }}>
                <div style={{ width: "70%" }}>
                  ...
                  >
                    ...
                    >
                      <Link className="ui fluid large button" to="/stream/edit">
                        Edit Stream
                      </Link>
                      <button
                        className="ui fluid large button red"
                      ...
                      {displayModal ? (
                        <Modal
                          ...
                          onEnd={onEnd}
                          title="End Stream"
                          message="This action is permanent. And it will also delete this stream forever"
                        />
                      ) : null}
                    </div>
                  </div>
              ...
              <div style={{ display: "flex" }}>
                <div style={{ width: "70%" }}>
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() => follow(!wasFollowed)}
                        className="ui fluid large button"
                      >
                        <i
                          className={`${wasFollowed ? "check" : "user"} icon`}
                        ></i>
                        {wasFollowed ? "Following" : "Follow"}
                      </button>
                      <button
                        onClick={() => subscribe(!wasSubscribed)}
                        className="ui fluid large button primary"
                      >
                        <i
                          className={`${
                            wasSubscribed ? "check" : "dollar"
                          } icon`}
                        ></i>
...
export default connect(mapStateToProps, { signInWithToken, getStream })(
  WatchStream
);
