            ...
            >
              <div className="column">
                <h1 className="ui black image header">
                  <div className="content">Your Profile</div>
                </h1>
                <div className="ui stacked segment">
                  ...
                  >
                    <Link
                      to="/"
                      className="ui  large button inverted secondary"
                    >
                  ...
                  >
                    <button
                      ...
                      className="ui  large button inverted red"
                    >
                    ...
                    {displayModal ? (
                      <Modal
                        ...
                        message="This action will delete you account forever and it cannot be undone."
                      />
                    ) : null}
                    <Link
